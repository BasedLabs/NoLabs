...
import gene_ontology_microservice.models
from dateutil.parser import parse
from gene_ontology_microservice import rest
...
from gene_ontology_microservice.exceptions import (ApiException, ApiValueError,
                                                   BadRequestException,
                                                   ForbiddenException,
                                                   NotFoundException,
                                                   ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gene_ontology_microservice.models, klass)
