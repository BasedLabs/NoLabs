...
class GetFastaFilesByIdsRequest(BaseModel):
    """
    GetFastaFilesByIdsRequest
    """ # noqa: E501
    rcsb_pdb_ids: List[StrictStr]
    job_id: Optional[JobId] = None
    __properties: ClassVar[List[str]] = ["rcsb_pdb_ids", "job_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rcsb_pdb_ids": obj.get("rcsb_pdb_ids"),
