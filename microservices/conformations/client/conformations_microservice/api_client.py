...
import conformations_microservice.models
from conformations_microservice import rest
...
from conformations_microservice.exceptions import (ApiException, ApiValueError,
                                                   BadRequestException,
                                                   ForbiddenException,
                                                   NotFoundException,
                                                   ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(conformations_microservice.models, klass)
