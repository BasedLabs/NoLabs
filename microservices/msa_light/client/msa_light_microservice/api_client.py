...
import msa_light_microservice.models
from dateutil.parser import parse
from msa_light_microservice import rest
...
from msa_light_microservice.exceptions import (ApiException, ApiValueError,
                                               BadRequestException,
                                               ForbiddenException,
                                               NotFoundException,
                                               ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(msa_light_microservice.models, klass)
