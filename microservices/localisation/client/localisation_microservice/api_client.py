...
import localisation_microservice.models
from dateutil.parser import parse
from localisation_microservice import rest
...
from localisation_microservice.exceptions import (ApiException, ApiValueError,
                                                  BadRequestException,
                                                  ForbiddenException,
                                                  NotFoundException,
                                                  ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(localisation_microservice.models, klass)
