...
class ResponseGetConfigApiReinventReinventConfigIdGet(BaseModel):
    ...
    # data type: ConfigurationResponse
    anyof_schema_1_validator: Optional[ConfigurationResponse] = None
    # data type: object
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ConfigurationResponse, object]]:
