    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            if request.is_homomer:
                ...
                output_dir = os.path.join(temp_dir, "homomer_designs")
                ...
                # Prepare output directory
                output_dir = os.path.join(temp_dir, "monomer_designs")
                os.makedirs(output_dir, exist_ok=True)
                ...
                input_pdb_path = os.path.join(input_pdbs_dir, os.path.basename(protein_file_path))
                shutil.copy(protein_file_path, input_pdb_path)
            ...
            # Clean up the temporary protein file
