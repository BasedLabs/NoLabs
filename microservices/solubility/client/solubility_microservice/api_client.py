...
import solubility_microservice.models
from dateutil.parser import parse
from solubility_microservice import rest
...
from solubility_microservice.exceptions import (ApiException, ApiValueError,
                                                BadRequestException,
                                                ForbiddenException,
                                                NotFoundException,
                                                ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(solubility_microservice.models, klass)
