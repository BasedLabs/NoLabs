...
import p2rank_microservice.models
from dateutil.parser import parse
from p2rank_microservice import rest
from p2rank_microservice.api_response import ApiResponse
from p2rank_microservice.configuration import Configuration
from p2rank_microservice.exceptions import (ApiException, ApiValueError,
                                            BadRequestException,
                                            ForbiddenException,
                                            NotFoundException,
                                            ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(p2rank_microservice.models, klass)
