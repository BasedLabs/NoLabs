...
import sc_gpt_microservice.models
from dateutil.parser import parse
from pydantic import SecretStr
from sc_gpt_microservice import rest
from sc_gpt_microservice.api_response import ApiResponse
from sc_gpt_microservice.api_response import T as ApiResponseT
from sc_gpt_microservice.configuration import Configuration
from sc_gpt_microservice.exceptions import (ApiException, ApiValueError,
                                            BadRequestException,
                                            ForbiddenException,
                                            NotFoundException,
                                            ServiceException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sc_gpt_microservice.models, klass)
