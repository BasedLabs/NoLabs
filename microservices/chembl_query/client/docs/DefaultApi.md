...
[**query_query_chembl_drugs_post**](DefaultApi.md#query_query_chembl_drugs_post) | **POST** /query-chembl-drugs | Query
...
# **query_query_chembl_drugs_post**
> ChEMBLMoleculeResponse query_query_chembl_drugs_post(ch_embl_molecule_request)
...
with chembl_query_microservice.ApiClient(configuration) as api_client:
    ...
    try:
        # Query
        api_response = api_instance.query_query_chembl_drugs_post(ch_embl_molecule_request)
        print("The response of DefaultApi->query_query_chembl_drugs_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->query_query_chembl_drugs_post: %s\n" % e)
```
