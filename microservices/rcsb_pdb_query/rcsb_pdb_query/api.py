...
from rcsb_pdb_query.services import fetch_fasta_files_by_ids
from rcsb_pdb_query.api_models import GetFastaFilesByIdsRequest, GetFastaFilesByIdsResponse, IsJobRunningResponse
...
def fetch(request: GetFastaFilesByIdsRequest) -> GetFastaFilesByIdsResponse:
    if request.job_id:
