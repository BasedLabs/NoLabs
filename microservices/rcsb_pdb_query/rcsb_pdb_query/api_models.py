...
@dataclasses.dataclass
class AttributeQueryRequest(BaseModelMixin):
    attribute: str
    value: Union[str, int, float, bool, list, dict]  # This supports various types of values
    operator: str  # E.g., "exact_match", "contains_phrase", etc.
    negation: bool = False
