...
from nolabs.workflow.application.use_cases import GetWorkflowSchemaFeature, CreateWorkflowSchemaFeature
...
class TestGetWorkflowSchemaFeature(IsolatedAsyncioTestCase):
    def shortDescription(self) -> str:
        return GetWorkflowSchemaFeature.__name__
    ...
    async def test_returns_existing_schema(self):
        """
        Happy path
        """
        ...
        create_workflow_schema = CreateWorkflowSchemaFeature()
        workflow_schema = await create_workflow_schema.start(experiment_id=experiment.id, components=[
            ComponentTest()
        ])
        get_workflow_schema = GetWorkflowSchemaFeature()
    ...
    async def test_input_output_types_are_matching(self):
        """
        Happy path
        """
