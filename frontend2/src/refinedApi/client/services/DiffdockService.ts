...
/* tslint:disable */
/* eslint-disable */
import type { nolabs__application__diffdock__api_models__GetJobStatusResponse } from '../models/nolabs__application__diffdock__api_models__GetJobStatusResponse';
...
export class DiffdockService {
     ...
     * @param jobId
     * @returns nolabs__application__diffdock__api_models__GetJobStatusResponse Successful Response
     * @throws ApiError
     */
    public static getJobStatusApiV1DiffdockJobsJobIdStatusGet(
        jobId: string,
    ): CancelablePromise<nolabs__application__diffdock__api_models__GetJobStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
