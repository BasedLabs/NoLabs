...
import type { nolabs__api_models__localisation__ExperimentMetadataResponse } from '../models/nolabs__api_models__localisation__ExperimentMetadataResponse';
import type { nolabs__api_models__localisation__GetExperimentResponse } from '../models/nolabs__api_models__localisation__GetExperimentResponse';
...
export class LocalisationService {
    ...
    /**
     * Experiments
     * @returns nolabs__api_models__localisation__ExperimentMetadataResponse Successful Response
     * @throws ApiError
     */
    public static experimentsApiV1LocalisationExperimentsGet(): CancelablePromise<Array<nolabs__api_models__localisation__ExperimentMetadataResponse>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * Get Experiment
     * @param experimentId
     * @returns nolabs__api_models__localisation__GetExperimentResponse Successful Response
     * @throws ApiError
     */
    public static getExperimentApiV1LocalisationGetExperimentGet(
        experimentId: string,
    ): CancelablePromise<nolabs__api_models__localisation__GetExperimentResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static generateUuidApiV1LocalisationGenerateIdGet(): CancelablePromise<GenerateUuidResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/localisation/generate_id',
        });
    }
}
