...
/* tslint:disable */
/* eslint-disable */
import type { nolabs__application__use_cases__solubility__api_models__GetJobStatusResponse } from '../models/nolabs__application__use_cases__solubility__api_models__GetJobStatusResponse';
...
export class SolubilityService {
     ...
     * @param jobId
     * @returns nolabs__application__use_cases__solubility__api_models__GetJobStatusResponse Successful Response
     * @throws ApiError
     */
    public static getJobStatusApiV1SolubilityJobsJobIdStatusGet(
        jobId: string,
    ): CancelablePromise<nolabs__application__use_cases__solubility__api_models__GetJobStatusResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/solubility/jobs/{job_id}/status',
            path: {
                'job_id': jobId,
            },
            errors: {
