<template>
  <q-card class="q-pa-md">
    <q-card-section class="bg-black row no-wrap items-center q-mt-sm text-white rounded-borders">
      <q-img class="rounded-borders" width="102px" height="102px" :src="'/rf_diffusion_pic.png'" alt="Lab Picture"/>
      <h5 class="q-pl-md">RFDiffusion</h5>
    </q-card-section>
