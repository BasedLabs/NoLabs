<template>
  ...
  import { nolabs__refined__application__use_cases__diffdock__api_models__JobResult, ProteinResponse } from "../../../../../refinedApi/client";
  
  export default defineComponent({
    name: 'DiffDockResult',
    components: { PdbViewer },
    props: {
      job: Object as () => { result: Array<nolabs__refined__application__use_cases__diffdock__api_models__JobResult> },
      protein: Object as () => ProteinResponse,
    },
    data() {
      return {
        ...
        predictedLigands: [] as nolabs__refined__application__use_cases__diffdock__api_models__JobResult[],
        ligandColumns: [
    ...
    methods: {
      ...
      handleRowClick(row: nolabs__refined__application__use_cases__diffdock__api_models__JobResult) {
