...
class NolabsApiModelsAminoAcidGeneOntologyAminoAcidResponse(BaseModel):
    """
    ...
    name: Optional[Any]
    go: Optional[Any]
    __properties: ClassVar[List[str]] = ["sequence", "name", "go"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if go (nullable) is None
        # and model_fields_set contains the field
        if self.go is None and "go" in self.model_fields_set:
            _dict['go'] = None
