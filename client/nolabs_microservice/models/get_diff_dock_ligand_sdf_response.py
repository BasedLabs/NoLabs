...
class GetDiffDockLigandSdfResponse(BaseModel):
    """
    GetDiffDockLigandSdfResponse
    """ # noqa: E501
    sdf_contents: Optional[Any]
    __properties: ClassVar[List[str]] = ["sdf_contents"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sdf_contents (nullable) is None
