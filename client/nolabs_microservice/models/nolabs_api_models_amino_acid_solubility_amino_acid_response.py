...
class NolabsApiModelsAminoAcidSolubilityAminoAcidResponse(BaseModel):
    """
    NolabsApiModelsAminoAcidSolubilityAminoAcidResponse
    """ # noqa: E501
    sequence: Optional[Any]
    name: Optional[Any]
    soluble_probability: Optional[Any]
    __properties: ClassVar[List[str]] = ["sequence", "name", "soluble_probability"]
