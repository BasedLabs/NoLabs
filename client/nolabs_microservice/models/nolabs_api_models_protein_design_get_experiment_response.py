...
class NolabsApiModelsProteinDesignGetExperimentResponse(BaseModel):
    """
    ...
    properties: NolabsApiModelsProteinDesignExperimentPropertiesResponse
    __properties: ClassVar[List[str]] = ["experiment_id", "experiment_name", "pdb_files", "properties"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "properties": NolabsApiModelsProteinDesignExperimentPropertiesResponse.from_dict(obj.get("properties")) if obj.get("properties") is not None else None
        })
        return _obj
