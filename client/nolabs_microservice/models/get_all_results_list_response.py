...
class GetAllResultsListResponse(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if results_list (nullable) is None
        # and model_fields_set contains the field
        if self.results_list is None and "results_list" in self.model_fields_set:
            _dict['results_list'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results_list": obj.get("results_list")
        })
        return _obj
