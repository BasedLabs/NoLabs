...
class NolabsApiModelsAminoAcidFoldingAminoAcidResponse(BaseModel):
    """
    NolabsApiModelsAminoAcidFoldingAminoAcidResponse
    """ # noqa: E501
    sequence: Optional[Any]
    name: Optional[Any]
    pdb_file_name: Optional[Any]
    pdb_file: Optional[Any]
    __properties: ClassVar[List[str]] = ["sequence", "name", "pdb_file_name", "pdb_file"]
