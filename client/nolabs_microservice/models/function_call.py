...
class FunctionCall(BaseModel):
    ...
    data: Optional[FunctionCallReturnData] = None
    __properties: ClassVar[List[str]] = ["function_name", "parameters", "data"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": FunctionCallReturnData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
