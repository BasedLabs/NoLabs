...
class ChemBLMetaData(BaseModel):
    """
    ChemBLMetaData
    """ # noqa: E501
    chembl_id: Optional[Any]
    link: Optional[Any]
    pref_name: Optional[Any]
    __properties: ClassVar[List[str]] = ["chembl_id", "link", "pref_name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pref_name (nullable) is None
        # and model_fields_set contains the field
        if self.pref_name is None and "pref_name" in self.model_fields_set:
            _dict['pref_name'] = None
