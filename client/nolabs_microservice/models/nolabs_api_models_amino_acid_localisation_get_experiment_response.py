...
class NolabsApiModelsAminoAcidLocalisationGetExperimentResponse(BaseModel):
    """
    ...
    properties: NolabsApiModelsAminoAcidLocalisationExperimentPropertiesResponse
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "properties": NolabsApiModelsAminoAcidLocalisationExperimentPropertiesResponse.from_dict(obj.get("properties")) if obj.get("properties") is not None else None
        })
        return _obj
