...
class NolabsApiModelsAminoAcidGeneOntologyGetExperimentResponse(BaseModel):
    """
    ...
    properties: NolabsApiModelsAminoAcidGeneOntologyExperimentPropertiesResponse
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "properties": NolabsApiModelsAminoAcidGeneOntologyExperimentPropertiesResponse.from_dict(obj.get("properties")) if obj.get("properties") is not None else None
        })
        return _obj
