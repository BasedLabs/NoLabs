...
class SmilesResponse(BaseModel):
    ...
    """ # noqa: E501
    smiles: Optional[Any]
    drug_likeness: Optional[Any]
    score: Optional[Any]
    created_at: Optional[Any]
    stage: Optional[Any]
    __properties: ClassVar[List[str]] = ["smiles", "drug_likeness", "score", "created_at", "stage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if drug_likeness (nullable) is None
        # and model_fields_set contains the field
        if self.drug_likeness is None and "drug_likeness" in self.model_fields_set:
            _dict['drug_likeness'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "drug_likeness": obj.get("drug_likeness"),
            "score": obj.get("score"),
