...
class NolabsApiModelsConformationsGetExperimentResponse(BaseModel):
    """
    NolabsApiModelsConformationsGetExperimentResponse
    """ # noqa: E501
    experiment_id: Optional[Any]
    experiment_name: Optional[Any]
    properties: NolabsApiModelsConformationsExperimentPropertiesResponse
    timeline: Optional[Any]
    pdb_file: PdbFile
    __properties: ClassVar[List[str]] = ["experiment_id", "experiment_name", "properties", "timeline", "pdb_file"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "properties": NolabsApiModelsConformationsExperimentPropertiesResponse.from_dict(obj.get("properties")) if obj.get("properties") is not None else None,
