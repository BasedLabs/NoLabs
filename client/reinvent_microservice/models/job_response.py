...
class JobResponse(BaseModel):
    ...
    learning_completed: Optional[Any]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if learning_completed (nullable) is None
        # and model_fields_set contains the field
        if self.learning_completed is None and "learning_completed" in self.model_fields_set:
            _dict['learning_completed'] = None
