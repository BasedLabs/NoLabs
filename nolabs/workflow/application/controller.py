...
from nolabs.workflow.application.schema import WorkflowSchema
...
async def get_schema(experiment_id: UUID) -> Optional[WorkflowSchema]:
    return await GetWorkflowSchemaFeature().handle(experiment_id=experiment_id)
