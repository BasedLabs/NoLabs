...
from workflow.data import ComponentData, PropertyErrorData

if TYPE_CHECKING:
    from workflow.tasks import ComponentFlow
...
class Parameter(BaseModel):
    ...
    def unmap(
        ...
        if not property and not target_path:
            raise ValueError("You must provide either property or target_path")
...
class Component(Generic[TInput, TOutput]):
    ...
    def input_errors(self):
        return self.input_schema.validate_dictionary(
