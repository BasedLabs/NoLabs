...
from nolabs.features.conformations import GetResultsFeature, DeleteExperimentFeature, RunSimulationsFeature, \
...
async def inference(request: RunSimulationsRequest,
                    feature: Annotated[RunSimulationsFeature, Depends(RunSimulationsFeature)]
