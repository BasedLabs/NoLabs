...
class GeneOntologyJob(Job):
    ...
    # endregion
    gene_ontologies: List[GeneOntologyJobResult] = EmbeddedDocumentListField(
    ...
    def set_result(self, result: List[Tuple[Protein, Dict[str, Any]]]):
        ...
        for protein, go in result:
            ...
            self.gene_ontologies.append(
                GeneOntologyJobResult(protein_id=protein.iid.value, gene_ontology=go)
            )
