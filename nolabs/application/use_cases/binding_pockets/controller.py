...
from nolabs.application.use_cases.binding_pockets.api_models import JobResponse, SetupJobRequest, \
    GetJobStatusResponse
from nolabs.application.use_cases.binding_pockets.di import BindingPocketsDependencies
