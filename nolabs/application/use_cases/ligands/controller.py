...
from nolabs.application.use_cases.ligands.api_models import (
    UpdateLigandRequest, UploadLigandResponse)
from nolabs.application.use_cases.ligands.di import \
    LigandsControllerDependencies
...
async def search_ligands_content(
    feature: Annotated[
        ...
        Depends(LigandsControllerDependencies.search_ligands_content),
    ],
...
async def search_ligands_metadata(
    feature: Annotated[
        ...
        Depends(LigandsControllerDependencies.search_ligands_metadata),
    ],
...
async def get_ligand_content(
    ligand_id: UUID,
    feature: Annotated[
        GetLigandFeature, Depends(LigandsControllerDependencies.get_ligand)
    ],
) -> Optional[LigandContentResponse]:
