...
class QueryRcsbPdbByNamesFunction(BiobuddyFunction):
    def __init__(
        self, rcsb_pdb_query_microservice: rcsb_pdb_query_microservice.DefaultApi
    ):
        parameters = [
            FunctionParameterDefinition(
                name="protein_names",
        ...
        super().__init__(
            "query_rcsb_pdb_by_protein_names",
            "Query RCSB PDB by protein names.",
            parameters,
        )
    ...
    def execute(self, arguments: Dict[str, Any]) -> FunctionCall:
        ...
        for protein_name in protein_names:
            request = rcsb_pdb_query_microservice.GetFastaFilesBySearchQueryRequest(
                search_query=protein_name, max_results=max_results
            )
        ...
        return FunctionCall(
            ...
            arguments=[FunctionParam(name="protein_names", value=protein_names)],
