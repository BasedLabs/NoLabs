...
router = APIRouter(
    prefix="/api/v1/small-molecules-design", tags=["small-molecules-design"]
)
...
async def get_job_status(
    feature: Annotated[
        GetJobStatusFeature, Depends(SmallMoleculesDesignDependencies.get_job_status)
    ],
    job_id: UUID,
...
async def run_learning_stage_job(
    feature: Annotated[
        ...
        Depends(SmallMoleculesDesignDependencies.run_learning),
    ],
    job_id: UUID,
):
    return await feature.handle(job_id=job_id)
...
async def get_job(
    feature: Annotated[
        GetJobFeature, Depends(SmallMoleculesDesignDependencies.get_job)
    ],
    job_id: UUID,
...
async def setup_job(
    feature: Annotated[
        SetupJobFeature, Depends(SmallMoleculesDesignDependencies.setup_job)
    ],
...
async def stop_job(
    feature: Annotated[
        StopJobFeature, Depends(SmallMoleculesDesignDependencies.stop_job)
    ],
    job_id: UUID,
):
    return await feature.handle(job_id=job_id)
...
async def delete_job(
    feature: Annotated[
        DeleteJobFeature, Depends(SmallMoleculesDesignDependencies.delete_job)
    ],
    job_id: UUID,
):
    return await feature.handle(job_id=job_id)
...
async def get_jog_logs(
    feature: Annotated[
        GetJobLogsFeature, Depends(SmallMoleculesDesignDependencies.get_job_logs)
    ],
    job_id: UUID,
) -> LogsResponse:
    return await feature.handle(job_id=job_id)
...
async def get_job_smiles(
    feature: Annotated[
        GetJobSmilesFeature, Depends(SmallMoleculesDesignDependencies.get_job_smiles)
    ],
    job_id: UUID,
) -> List[SmilesResponse]:
    return await feature.handle(job_id=job_id)
