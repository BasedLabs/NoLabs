...
conformations_logger = logging.StreamHandler()
conformations_logger.setLevel(logging.DEBUG)
conformations_logger.addFilter(ConformationsSocketIOEmitFilter())
conformations_errors_logger.addHandler(conformations_logger)
