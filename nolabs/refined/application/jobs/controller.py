...
from nolabs.refined.application.jobs.api_models import GetJobMetadataResponse, UpdateJobRequest
from nolabs.refined.application.jobs.di import JobDependencies
