...
from nolabs.refined.application.use_cases.gene_ontology.api_models import JobResponse, SetupJobRequest
from nolabs.refined.application.use_cases.gene_ontology.di import GeneOntologyDependencies
from nolabs.refined.application.use_cases.gene_ontology.use_cases import RunJobFeature, GetJobFeature, SetupJobFeature
