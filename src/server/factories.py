...
def api_handlers_factory(is_test=False, is_demo=False):
    ...
    if is_demo:
        ...
        return AminoAcidLabDemoApiHandler(), DrugTargetDemoApiHandler(), ConformationsApiHandler()
    ...
    return AminoAcidLabApiHandler(), DrugTargetApiHandler(), ConformationsApiHandler()
